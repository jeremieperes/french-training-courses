...
def clean_data(df):
    with st.spinner('Please wait : the app is cleaning data'):
        ...
        df_copy['Ville'] = df_copy['Ville'].str.replace('FRANCONVILLE LA GARENNE','FRACONVILLE')
        ...
        df_copy['Ville'] = df_copy['Ville'].str.replace('SAINT PRIESAINT EN JAREZ','SAINT PRIEST')
        df_copy['Ville'] = df_copy['Ville'].str.replace('BAGNOLES DE L ORNE NORMAND','BAGNOLE DE L ORNE')
...
if navigation=='Home':
    ...
    if gran=='Par Département':
        ...
        **Nombre de formations pour 1000 habitants**
        ...
        '''
        **Top des villes entre 40 et 80.000 habitants où le nombre de formations pour 1000 habitants est le plus faible**
        '''
